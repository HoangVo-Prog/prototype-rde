...
# prototype-rde keeps the runnable RDE package under this nested directory.
...
def default_model_args() -> Dict[str, Any]:
    # RDE's run script trains with TAL/TRL/InfoNCE/SDM names; TAL is the safe inference default.
    return {
        "noisy_rate": 0.0,
        "noisy_file": "",
        "tau": 0.015,
